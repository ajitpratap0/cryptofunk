...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_positions_unrealized_pnl
...
DROP INDEX CONCURRENTLY IF EXISTS idx_orders_session;
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_orders_session_id_created
