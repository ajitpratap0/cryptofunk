...
/status — System status, running agents, uptime, last trade
/positions — Open positions: symbol, side, entry, P&L
/trades — Recent trade history (last 10)
/balance — Portfolio balance, margin, total P&L

*🎮 Trading Control:*
/starttrade — Enable live trading (with confirmation)
/stoptrade — Emergency stop all trading
...
*Legacy Commands:*
/pl — Detailed P&L report
/decisions — Recent agent decisions
/pause — Pause trading (alias for /stoptrade)
/resume — Resume trading (alias for /starttrade)`
